		...
		<div className='h-screen w-full flex z-40 relative'>
			<div className='flex justify-center items-center z-50 w-full'>
				<div className='flex flex-col items-center gap-4'>
					...
					<h1 className='text-3xl font-spaceGrotesk font-bold'>{t("Add contacts to start chatting")}</h1>
					<Form {...contactForm}>
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										<Label>{t("Email")}</Label>
										<FormControl>
											<Input placeholder='info@example.com' disabled={isCreating} className='h-10 bg-secondary' {...field} />
										</FormControl>

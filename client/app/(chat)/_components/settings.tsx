		...
		<>
				...
				<PopoverContent className='p-0 w-80'>
					...
					<div className='flex flex-col'>
						...
						>
							<div className='flex items-center gap-1'>
								<UserPlus size={16} />
								<span className='text-sm'>{t("Create contact")}</span>
							</div>
						</div>
						...
						<div className='flex justify-between items-center p-2 hover:bg-secondary'>
							<div className='flex items-center gap-1'>
								<VolumeOff size={16} />
								<span className='text-sm'>{t("Mute")}</span>
							</div>
							<Switch
						...
						<div className='flex justify-between items-center p-2 hover:bg-secondary'>
							<div className='flex items-center gap-1'>
								...
								<span className='text-sm'>{resolvedTheme === 'dark' ? t('Light mode') : t('Dark mode')}</span>
							</div>
							<Switch
			...
			<Sheet open={isProfileOpen} onOpenChange={setIsProfileOpen}>
				<SheetContent side={'left'} className='w-80 p-2 max-md:w-full'>
					<SheetHeader>
						<SheetTitle className='text-2xl'>{t("My profile")}</SheetTitle>
						<SheetDescription>
							{t("Setting up your profile will help you connect with your friends and family easily.")}
						</SheetDescription>
					</SheetHeader>
					...
					<Accordion type='single' collapsible className='mt-4'>
						<AccordionItem value='item-1'>
							<AccordionTrigger className='bg-secondary px-2'>{t("Basic information")}</AccordionTrigger>
						...
						<AccordionItem value='item-2' className='mt-2'>
							<AccordionTrigger className='bg-secondary px-2'>{t("Email")}</AccordionTrigger>
							<AccordionContent className='px-2 mt-2'>
								<EmailForm />
							</AccordionContent>
						</AccordionItem>
						...
						<AccordionItem value='item-3' className='mt-2'>
							<AccordionTrigger className='bg-secondary px-2'>{t("Notification")}</AccordionTrigger>
						...
						<AccordionItem value='item-4' className='mt-2'>
							<AccordionTrigger className='bg-secondary px-2'>{t("Delete account")}</AccordionTrigger>
